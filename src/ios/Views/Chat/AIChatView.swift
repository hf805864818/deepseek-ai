...
struct AIChatView: View {
    ...
    /// [T-ios-runtime-demangle-watchdog] Input popup overlay (slash command
    /// + @ mention menus), extracted to `InputPopupOverlayView` top-level
    /// struct to cut the type tree at a struct boundary.
    private var inputPopupOverlay: some View {
        InputPopupOverlayView(vm: vm, maxContentWidth: maxContentWidth)
    }
