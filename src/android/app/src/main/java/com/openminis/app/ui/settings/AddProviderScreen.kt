...
private fun ColumnScope.OAuthConfigSection(
    ...
    val signInLabel = when (providerType) {
        ...
        ProviderType.antigravity,
        ProviderType.unsupported -> "Unsupported provider"
    }
    ...
    if (isAuthenticated) {
        ...
        val defaultUrl = when (providerType) {
            ...
            // [T-android-provider-type-parity] Responses API shares OpenAI's
            // default; decode-only types are never offered for creation here.
